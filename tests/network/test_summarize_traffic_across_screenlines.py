...
def test_traffic_across_screenlines(
        am_auto_network, screenlines_path, expected):
    ...
    pd.testing.assert_frame_equal(test_res, expected, check_names=False)
